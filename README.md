...
Go to Dr.Meetings [https://dr-meetings.onrender.com/](https://dr-meetings.onrender.com/)
...
- As a registered user, I want to be able to turn off or turn on my camera, so that other users can or cannot see me.
...
![Payment page](documentation/features/payment_page.png)
...
![Successful subscription creation](documentation/features/email_successful_payment2.png)

And the following email will be also sent to the user about the payment:

![Successful payment page](documentation/features/email_successful_payment1.png)
...
![Success alert](documentation/features/login_success_msg.png)
