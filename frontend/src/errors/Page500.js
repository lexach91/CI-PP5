    ...
    return (
        <Layout title="Page Not Found">
            ...
            <div className="surface-50 border-round text-700 text-center md:w-8 md:mx-auto my-2 md:my-5 p-5">
                <div className="text-blue-600 font-bold mb-3"><i className="pi pi-exclamation-triangle"></i>500 Error</div>
                <div className="text-900 font-bold text-5xl mb-3">Internal server error!</div>
