...
const PrivacyHtml = () => {
  return (
    <div className="md:w-8 md:mx-auto p-1 md:p-4">
      <h1>Privacy Policy for Dr.Meetings</h1>
      ...
      <p>
        ...
        and recorded by Dr.Meetings and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Dr.Meetings. This policy is not applicable to
        ...
        <a
          ...
          rel="noopener noreferrer"
          className="text-blue-500"
          aria-label="Free Privacy Policy Generator">
      ...
      <p>
        Dr.Meetings follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Dr.Meetings uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of Dr.Meetings.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Dr.Meetings, which are sent
      ...
      <p>
        Note that Dr.Meetings has no access to or control over these cookies
      ...
      <p>
        Dr.Meetings's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Dr.Meetings does not knowingly collect any Personal Identifiable
