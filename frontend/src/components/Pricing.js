  ...
  return loading ? (
    ...
    <LayoutComponent title="Pricing">
      ...
      <div className="surface-0">
        <div className="text-900 font-bold text-6xl mb-4 mt-4 text-center">
          Pricing Plans
        </div>
              ...
              <div
                ...
                <ul className="list-none p-0 m-0 flex-grow-1">
                  <li className="flex align-items-center mb-3">
                    ...
                    <span>Up to 4 people in a room</span>
                  </li>
                  <li className="flex align-items-center mb-3">
                    <i className="pi pi-check-circle text-green-500 mr-2"></i>
            ...
            <div className="p-3 h-full">
              <div
                ...
                <ul className="list-none p-0 m-0 flex-grow-1">
                  <li className="flex align-items-center mb-3">
                    <i className="pi pi-check-circle text-green-500 mr-2"></i>
                    <span>Up to 9 people in a room</span>
                  </li>
                  <li className="flex align-items-center mb-3">
                    <i className="pi pi-check-circle text-green-500 mr-2"></i>
                    <span>Unlimited meeting duration</span>
            ...
            <div className="p-3 h-full">
              <div
                ...
                <ul className="list-none p-0 m-0 flex-grow-1">
                  <li className="flex align-items-center mb-3">
                    <i className="pi pi-check-circle text-green-500 mr-2"></i>
                    <span>Up to 12 people in a room</span>
                  </li>
                  <li className="flex align-items-center mb-3">
                    <i className="pi pi-check-circle text-green-500 mr-2"></i>
                    <span>Unlimited meeting duration</span>
        ...
        {!isAuthenticated && (
          <div className="surface-0 text-700 text-center mt-8 mb-8 p-8">
            ...
            <div className="text-700 text-2xl mb-5">
              Open a free account now and you can join other people's meetings
              if you have a link.
            </div>
            <Button
              label="Register"
